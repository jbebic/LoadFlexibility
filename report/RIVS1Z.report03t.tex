...
\fancypagestyle{title}{ % defining header style for the first page
  ...
  \textsc{\textbf{\Huge Customer Report for: RIVS1Z}}
  \end{tabular}}`
  \fancyfoot[L]{\today}
  \fancyfoot[C]{}
...
\fancypagestyle{energy}{ % header style for energy charges
  ...
  \fancyhead[C]{}
  \fancyhead[R]{\textsc{\textbf{\Huge RIVS1Z}}}
  \fancyfoot[L]{\today}
  \fancyfoot[C]{}
  \fancyfoot[R]{\thepage/\pageref{LastPage}}
}
...
\begin{figure}[!h]
\centering
\includegraphics[height=3in, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/RIVS1Z.piechart.pdf}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/RIVS1Z.boxplot.pdf}
\caption{Makeup of monthly charges}
\label{fig:bars}
\end{figure}

Note that the demand charges are collected only in the four summer months, yet they account for 56.3\% of the total annual bill. The expected annual charges by bill component are summarized in Table~\ref{tab:annual}.
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/RIVS1Z.heatmap.pdf}
\caption{Normalized consumption for RIVS1Z}
\label{fig:heatmap}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 3in 0in 0.45in, clip]{visuals/RIVS1Z.billing.Heatmap.pdf}
...
\begin{table}[th!]
  ...
  \begin{tabular}{p{0.75in}rp{0.2in}p{0.75in}r}
    ...
    \midrule
    Jan & 1476.30 & & Jul & 1750.87 \\
    Feb & 1313.24 & & Aug & 2087.18 \\
    Mar & 1591.71 & & Sep & 1942.72 \\
    Apr & 1458.30 & & Oct & 1721.27 \\
    Jun & 1697.53 & & Nov & 1405.49 \\
    May & 1488.62 & & Dec & 1413.38 \\
    \midrule
    Average & 1612.22 & & &
  \end{tabular}
\end{table}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 2.1in 0in 2.1in, clip]{visuals/RIVS1Z.whiskerchart.pdf}
\caption{Average annual energy price for RIVS1Z compared to peers}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/RIVS1Z.duration.monthly.test.pdf}
\caption{Normalized load and demand profiles for RIVS1Z}
\label{fig:duration}
\end{figure}
...
\begin{table}[th!]
  ...
  \begin{tabular}{p{0.75in}rp{0.2in}p{0.75in}r}
    Month & Charge [\$] & & Month & Charge [\$] \\
    \midrule
    Jan & 1627.14 & & Jul & 3137.89 \\
    Feb & 1322.05 & & Aug & 3786.29 \\
    Mar & 1245.78 & & Sep & 3987.33 \\
    Apr & 1144.08 & & Oct & 1805.10 \\
    May & 1220.35 & & Nov & 1271.20 \\
    Jun & 2974.35 & & Dec & 1423.74 \\
    \midrule
    Average & 2078.77
  \end{tabular}
\end{table}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 3.8in 0in 0.5in, clip]{visuals/RIVS1Z.whiskerchart.pdf}
\caption{Average annual demand price for RIVS1Z compared to peers}
