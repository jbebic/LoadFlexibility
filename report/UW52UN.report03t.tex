...
\fancypagestyle{title}{ % defining header style for the first page
  ...
  \textsc{\textbf{\Huge Customer Report for: UW52UN}}
  \end{tabular}}`
  \fancyfoot[L]{\today}
  \fancyfoot[C]{}
...
\fancypagestyle{energy}{ % header style for energy charges
  ...
  \fancyhead[C]{}
  \fancyhead[R]{\textsc{\textbf{\Huge UW52UN}}}
  \fancyfoot[L]{\today}
  \fancyfoot[C]{}
  \fancyfoot[R]{\thepage/\pageref{LastPage}}
}
...
\begin{figure}[!h]
\centering
\includegraphics[height=3in, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/UW52UN.piechart.pdf}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/UW52UN.boxplot.pdf}
\caption{Makeup of monthly charges}
\label{fig:bars}
\end{figure}

Note that the demand charges are collected only in the four summer months, yet they account for 55.3\% of the total annual bill. The expected annual charges by bill component are summarized in Table~\ref{tab:annual}.
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/UW52UN.heatmap.pdf}
\caption{Normalized consumption for UW52UN}
\label{fig:heatmap}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 3in 0in 0.45in, clip]{visuals/UW52UN.billing.Heatmap.pdf}
...
\begin{table}[th!]
  ...
  \begin{tabular}{p{0.75in}rp{0.2in}p{0.75in}r}
    ...
    \midrule
    Jan & 2205.09 & & Jul & 3276.81 \\
    Feb & 2042.60 & & Aug & 3332.83 \\
    Mar & 2395.34 & & Sep & 3031.81 \\
    Apr & 2193.82 & & Oct & 2661.84 \\
    Jun & 2947.92 & & Nov & 2217.32 \\
    May & 2350.80 & & Dec & 2041.04 \\
    \midrule
    Average & 2558.10 & & &
  \end{tabular}
\end{table}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 2.1in 0in 2.1in, clip]{visuals/UW52UN.whiskerchart.pdf}
\caption{Average annual energy price for UW52UN compared to peers}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/UW52UN.duration.monthly.test.pdf}
\caption{Normalized load and demand profiles for UW52UN}
\label{fig:duration}
\end{figure}
...
\begin{table}[th!]
  ...
  \begin{tabular}{p{0.75in}rp{0.2in}p{0.75in}r}
    Month & Charge [\$] & & Month & Charge [\$] \\
    \midrule
    Jan & 1525.44 & & Jul & 5718.56 \\
    Feb & 1677.98 & & Aug & 5862.91 \\
    Mar & 1728.83 & & Sep & 5976.52 \\
    Apr & 1728.83 & & Oct & 2542.40 \\
    May & 2084.77 & & Nov & 1779.68 \\
    Jun & 5718.20 & & Dec & 1677.98 \\
    \midrule
    Average & 3168.51
  \end{tabular}
\end{table}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 3.8in 0in 0.5in, clip]{visuals/UW52UN.whiskerchart.pdf}
\caption{Average annual demand price for UW52UN compared to peers}
