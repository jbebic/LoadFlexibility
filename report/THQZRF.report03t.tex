...
\fancypagestyle{title}{ % defining header style for the first page
  ...
  \textsc{\textbf{\Huge Customer Report for: THQZRF}}
  \end{tabular}}`
  \fancyfoot[L]{\today}
  \fancyfoot[C]{}
...
\fancypagestyle{energy}{ % header style for energy charges
  ...
  \fancyhead[C]{}
  \fancyhead[R]{\textsc{\textbf{\Huge THQZRF}}}
  \fancyfoot[L]{\today}
  \fancyfoot[C]{}
  \fancyfoot[R]{\thepage/\pageref{LastPage}}
}
...
\begin{figure}[!h]
\centering
\includegraphics[height=3in, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/THQZRF.piechart.pdf}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/THQZRF.boxplot.pdf}
\caption{Makeup of monthly charges}
\label{fig:bars}
\end{figure}

Note that the demand charges are collected only in the four summer months, yet they account for 58.8\% of the total annual bill. The expected annual charges by bill component are summarized in Table~\ref{tab:annual}.
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/THQZRF.heatmap.pdf}
\caption{Normalized consumption for THQZRF}
\label{fig:heatmap}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 3in 0in 0.45in, clip]{visuals/THQZRF.billing.Heatmap.pdf}
...
\begin{table}[th!]
  ...
  \begin{tabular}{p{0.75in}rp{0.2in}p{0.75in}r}
    ...
    \midrule
    Jan & 1790.92 & & Jul & 2979.73 \\
    Feb & 1758.35 & & Aug & 3661.42 \\
    Mar & 2400.88 & & Sep & 3278.86 \\
    Apr & 2196.68 & & Oct & 2807.89 \\
    Jun & 2904.88 & & Nov & 2163.15 \\
    May & 2222.85 & & Dec & 1943.86 \\
    \midrule
    Average & 2509.12 & & &
  \end{tabular}
\end{table}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 2.1in 0in 2.1in, clip]{visuals/THQZRF.whiskerchart.pdf}
\caption{Average annual energy price for THQZRF compared to peers}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/THQZRF.duration.monthly.test.pdf}
\caption{Normalized load and demand profiles for THQZRF}
\label{fig:duration}
\end{figure}
...
\begin{table}[th!]
  ...
  \begin{tabular}{p{0.75in}rp{0.2in}p{0.75in}r}
    Month & Charge [\$] & & Month & Charge [\$] \\
    \midrule
    Jan & 1815.27 & & Jul & 6099.49 \\
    Feb & 1983.07 & & Aug & 6721.41 \\
    Mar & 2005.95 & & Sep & 7105.37 \\
    Apr & 2311.04 & & Oct & 3233.93 \\
    May & 2005.95 & & Nov & 2311.04 \\
    Jun & 5270.60 & & Dec & 2105.11 \\
    \midrule
    Average & 3580.69
  \end{tabular}
\end{table}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 3.8in 0in 0.5in, clip]{visuals/THQZRF.whiskerchart.pdf}
\caption{Average annual demand price for THQZRF compared to peers}
