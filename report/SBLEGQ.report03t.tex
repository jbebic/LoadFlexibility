...
\fancypagestyle{title}{ % defining header style for the first page
  ...
  \textsc{\textbf{\Huge Customer Report for: SBLEGQ}}
  \end{tabular}}`
  \fancyfoot[L]{\today}
  \fancyfoot[C]{}
...
\fancypagestyle{energy}{ % header style for energy charges
  ...
  \fancyhead[C]{}
  \fancyhead[R]{\textsc{\textbf{\Huge SBLEGQ}}}
  \fancyfoot[L]{\today}
  \fancyfoot[C]{}
  \fancyfoot[R]{\thepage/\pageref{LastPage}}
}
...
\begin{figure}[!h]
\centering
\includegraphics[height=3in, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/SBLEGQ.piechart.pdf}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/SBLEGQ.boxplot.pdf}
\caption{Makeup of monthly charges}
\label{fig:bars}
\end{figure}

Note that the demand charges are collected only in the four summer months, yet they account for 54.4\% of the total annual bill. The expected annual charges by bill component are summarized in Table~\ref{tab:annual}.
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/SBLEGQ.heatmap.pdf}
\caption{Normalized consumption for SBLEGQ}
\label{fig:heatmap}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 3in 0in 0.45in, clip]{visuals/SBLEGQ.billing.Heatmap.pdf}
...
\begin{table}[th!]
  ...
  \begin{tabular}{p{0.75in}rp{0.2in}p{0.75in}r}
    ...
    \midrule
    Jan & 2356.51 & & Jul & 3997.77 \\
    Feb & 2181.81 & & Aug & 4201.49 \\
    Mar & 2814.73 & & Sep & 3708.66 \\
    Apr & 2680.94 & & Oct & 4712.25 \\
    Jun & 3657.26 & & Nov & 4398.23 \\
    May & 2872.41 & & Dec & 2929.48 \\
    \midrule
    Average & 3375.96 & & &
  \end{tabular}
\end{table}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 2.1in 0in 2.1in, clip]{visuals/SBLEGQ.whiskerchart.pdf}
\caption{Average annual energy price for SBLEGQ compared to peers}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/SBLEGQ.duration.monthly.test.pdf}
\caption{Normalized load and demand profiles for SBLEGQ}
\label{fig:duration}
\end{figure}
...
\begin{table}[th!]
  ...
  \begin{tabular}{p{0.75in}rp{0.2in}p{0.75in}r}
    Month & Charge [\$] & & Month & Charge [\$] \\
    \midrule
    Jan & 1731.37 & & Jul & 6410.74 \\
    Feb & 1685.61 & & Aug & 7098.50 \\
    Mar & 1975.44 & & Sep & 7886.72 \\
    Apr & 1899.17 & & Oct & 5827.18 \\
    May & 2120.36 & & Nov & 3996.65 \\
    Jun & 5720.51 & & Dec & 2036.46 \\
    \midrule
    Average & 4032.39
  \end{tabular}
\end{table}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 3.8in 0in 0.5in, clip]{visuals/SBLEGQ.whiskerchart.pdf}
\caption{Average annual demand price for SBLEGQ compared to peers}
