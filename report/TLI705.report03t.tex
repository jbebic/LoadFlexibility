...
\fancypagestyle{title}{ % defining header style for the first page
  ...
  \textsc{\textbf{\Huge Customer Report for: TLI705}}
  \end{tabular}}`
  \fancyfoot[L]{\today}
  \fancyfoot[C]{}
...
\fancypagestyle{energy}{ % header style for energy charges
  ...
  \fancyhead[C]{}
  \fancyhead[R]{\textsc{\textbf{\Huge TLI705}}}
  \fancyfoot[L]{\today}
  \fancyfoot[C]{}
  \fancyfoot[R]{\thepage/\pageref{LastPage}}
}
...
\begin{figure}[!h]
\centering
\includegraphics[height=3in, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/TLI705.piechart.pdf}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/TLI705.boxplot.pdf}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/TLI705.heatmap.pdf}
\caption{Normalized consumption for TLI705}
\label{fig:heatmap}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 3in 0in 0.45in, clip]{visuals/TLI705.billing.Heatmap.pdf}
...
\begin{table}[th!]
  ...
  \begin{tabular}{p{0.75in}rp{0.2in}p{0.75in}r}
    ...
    \midrule
    Jan & 1247.59 & & Jul & 2037.07 \\
    Feb & 1136.52 & & Aug & 2317.82 \\
    Mar & 1337.31 & & Sep & 1943.18 \\
    Apr & 1349.90 & & Oct & 1597.28 \\
    Jun & 1822.48 & & Nov & 1375.91 \\
    May & 1453.72 & & Dec & 1310.25 \\
    \midrule
    Average & 1577.42 & & &
  \end{tabular}
\end{table}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 2.1in 0in 2.1in, clip]{visuals/TLI705.whiskerchart.pdf}
\caption{Average annual energy price for TLI705 compared to peers}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 0.45in 0in 0.45in, clip]{visuals/TLI705.duration.monthly.test.pdf}
\caption{Normalized load and demand profiles for TLI705}
\label{fig:duration}
\end{figure}
...
\begin{table}[th!]
  ...
  \begin{tabular}{p{0.75in}rp{0.2in}p{0.75in}r}
    Month & Charge [\$] & & Month & Charge [\$] \\
    \midrule
    Jan & 813.57 & & Jul & 3949.09 \\
    Feb & 813.57 & & Aug & 3845.92 \\
    Mar & 864.42 & & Sep & 4250.17 \\
    Apr & 1016.96 & & Oct & 1881.38 \\
    May & 1372.90 & & Nov & 915.26 \\
    Jun & 3560.73 & & Dec & 915.26 \\
    \midrule
    Average & 2016.60
  \end{tabular}
\end{table}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\columnwidth, page=1, trim=0in 3.8in 0in 0.5in, clip]{visuals/TLI705.whiskerchart.pdf}
\caption{Average annual demand price for TLI705 compared to peers}
